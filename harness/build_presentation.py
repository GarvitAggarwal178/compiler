...
EXPLAIN_DIR = REPO / "experiments" / "explain-samples"
...
OUT_PATH = REPO / "results" / "presentation.html"
...
def build_findings_section():
    ...
    <div class="card">
      ...
      <code>experiments/49-demand-relaxation.md</code>, not a bug).</p>
      <table>
...
<header>
  ...
  every number here also appears in <code>experiments/57-final-report-whole-project-synthesis.md</code>, with its
...
<section id="findings">
  ...
  <p class="lead">The two results <code>experiments/57-final-report-whole-project-synthesis.md</code> section 6
  names as carrying the presentation.</p>
  {findings}
</section>

</main>
<footer>Generated from committed material only &mdash; see <code>experiments/57-final-report-whole-project-synthesis.md</code> for the full report.</footer>
</body>
</html>
"""
