...
| Q12 (`p2.dl` predicted `T_dlc ≈ 300–700`) | `record/OPEN_QUESTIONS.md`, measured 974/252 | Measured — **missed under both conventions** | Not recorded as correct under either convention; see `results/superseded.md`. |
